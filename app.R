  ...
  tabItems(
    ...
    tabItem(tabName = "point1-1",
            fluidRow(
              ...
              valueBoxOutput(width = 6, "point1_info2")
            ),
            fluidRow(
              column(width = 4,
                     box(
    ...
    tabItem(tabName = "point1-2",
            fluidRow(
              ...
              valueBoxOutput("point1_info4"),
              valueBoxOutput("point1_info5")
            ),
            fluidRow(
              column(width = 2,
                     box(
    ...
    tabItem(tabName = "point2-1",
            fluidRow(
              valueBoxOutput(width = 6, "point2_info1"),
              valueBoxOutput(width = 6, "point2_info2"),
            ),
            fluidRow(
              column(width = 4,
                     box(
    ...
    tabItem(tabName = "point2-2",
            fluidRow(
              valueBoxOutput(width = 6, "point2_info3"),
              valueBoxOutput(width = 6, "point2_info4"),
            ),
            fluidRow(
              column(width = 3,
                     box(
    ...
    tabItem(tabName = "point3-1",
            fluidRow(
              valueBoxOutput(width = 12, "point3_info1"),
            ),
            fluidRow(
              column(width = 3,
                     box(
    ...
    tabItem(tabName = "point3-2",
            fluidRow(
              valueBoxOutput(width = 12, "point3_info2"),
            ),
            fluidRow(
              column(width = 3,
                     box(
    ...
    tabItem(tabName = "point3-3",
            fluidRow(
              valueBoxOutput(width = 6, "point3_info3"),
              valueBoxOutput(width = 6, "point3_info4"),
            ),
            fluidRow(
              column(width = 2,
                    box(
...
server <- function(input, output, session) {
  ...
  statstable <- reactive ({
   ...
   output$point1_info4 <- renderValueBox({
     valueBox(
       "80%", "Approval", icon = icon("thumbs-up", lib = "glyphicon"),
       color = "light-blue")
   })
   
   output$point1_info5 <- renderValueBox({
     valueBox(
       "80%", "Approval", icon = icon("thumbs-up", lib = "glyphicon"),
       color = "purple")
   })
   ...
   output$point2_info4 <- renderValueBox({
     valueBox(
       "80%", "Approval", icon = icon("thumbs-up", lib = "glyphicon"),
       color = "light-blue")
   })
   ...
   output$point3_info4 <- renderValueBox({
     valueBox(
       "80%", "Approval", icon = icon("thumbs-up", lib = "glyphicon"),
       color = "light-blue")
   })
